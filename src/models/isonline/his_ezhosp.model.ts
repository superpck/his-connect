...
export class HisEzhospModel {
    ...
    getOpdService(db: Knex, hn, date, columnName = '', searchText = '') {
        ...
        return db('view_opd_visit as visit')
            ...
            .select('visit.hn', 'visit.vn as visitno', 'visit.date', 'visit.time',
                'visit.time_drug as time_end', 'visit.pttype_std2 as pttype',
                'visit.insclass as payment', 'visit.emg as triage',
                'visit.dep as clinic_local_code', 'visit.dep_name as clinic_local_name',
                'visit.dep_standard as clinic', 'visit.dr',
                'visit.bp as bp_systolic', 'visit.bp1 as bp_diastolic',
                'visit.puls as pr', 'visit.rr', 'visit.fu as appoint',
                'triage.e as gcs_e', 'triage.v as gcs_v', 'triage.m as gcs_m',
                'triage.gcs', 'triage.o2sat',
                'visit.status as result', 'visit.refer as referin')
            .where(where)
    ...
    getOpdServiceByVN(db: Knex, vn: any, where: any = null) {
        ...
        return sql.select('visit.hn', 'visit.vn as visitno', 'visit.date', 'visit.time',
            'visit.time_drug as time_end', 'visit.pttype_std2 as pttype',
            'visit.insclass as payment', 'visit.emg as triage',
            'visit.dep as clinic_local_code', 'visit.dep_name as clinic_local_name',
            'visit.dep_standard as clinic', 'visit.dr',
