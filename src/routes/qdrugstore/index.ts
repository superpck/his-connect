...
const router = (fastify, { }, next) => {
  ...
  fastify.post('/service', { preHandler: [fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
    ...
    try {
      ...
      const result = await cannabisModel.searchVisit(fastify.dbHIS, textSearch);
  ...
  fastify.post('/visit', { preHandler: [fastify.serviceMonitoring, fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
    ...
    if (hn) {
      try {
        const result: any = await cannabisModel.searchVisit(fastify.dbHIS, hn);
        reply.send({
          statusCode: HttpStatus.OK,
          rows: result
        });
  ...
  fastify.post('/patient-info', { preHandler: [fastify.serviceMonitoring, fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
    ...
    if (hn) {
      try {
        const result: any = await cannabisModel.patientInfo(fastify.dbHIS, hn);
        reply.send({
          statusCode: HttpStatus.OK,
          rows: result
        });
  ...
  fastify.post('/lab', { preHandler: [fastify.serviceMonitoring, fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
    ...
    if (hn && vn) {
      try {
        const result: any = await cannabisModel.getVisitLab(fastify.dbHIS, hn, vn);
        reply.send({
          statusCode: HttpStatus.OK,
          rows: result
        });
  ...
  fastify.post('/drug-opd', { preHandler: [fastify.serviceMonitoring, fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
    const hn = req.body.hn || '';
    const vn = req.body.vn || '';

    if (hn && vn) {
      try {
        const result: any = await cannabisModel.getVisitDrug(fastify.dbHIS, hn, vn);
        reply.send({
          statusCode: HttpStatus.OK,
          rows: result
        });
  ...
  fastify.post('/appointment', { preHandler: [fastify.serviceMonitoring, fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
    ...
    if (hn && vn) {
      try {
        const result: any = await cannabisModel.getVisitAppointment(fastify.dbHIS, hn, vn);
        reply.send({
          statusCode: HttpStatus.OK,
          rows: result
        });
  ...
  fastify.post('/diag-text', { preHandler: [fastify.serviceMonitoring, fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
    ...
    if (hn && vn) {
      try {
        const result: any = await cannabisModel.getVisitDiagText(fastify.dbHIS, hn, vn);
        reply.send({
          statusCode: HttpStatus.OK,
          rows: result
        });
  ...
  fastify.post('/diagnosis', { preHandler: [fastify.serviceMonitoring, fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
    ...
    if (hn && vn) {
      try {
        const result: any = await cannabisModel.getVisitDiagnosis(fastify.dbHIS, hn, vn);
        reply.send({
          statusCode: HttpStatus.OK,
          rows: result
        });
  ...
  fastify.post('/procedure', { preHandler: [fastify.serviceMonitoring, fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
    ...
    if (hn && vn) {
      try {
        const result: any = await cannabisModel.getVisitProcedure(fastify.dbHIS, hn, vn);
        reply.send({
          statusCode: HttpStatus.OK,
          rows: result
        });
  ...
  fastify.post('/screening', { preHandler: [fastify.serviceMonitoring, fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
    ...
    if (hn && vn) {
      try {
        const result: any = await cannabisModel.getVisitScreening(fastify.dbHIS, hn, vn);
        reply.send({
          statusCode: HttpStatus.OK,
          rows: result
        });
  ...
  // =============================================================
  fastify.post('/drug-opd-refer', { preHandler: [fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
  ...
  // =============================================================
  fastify.post('/appointment_refer', { preHandler: [fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
