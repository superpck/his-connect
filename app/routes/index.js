...
const router = (fastify, {}, next) => {
    ...
    fastify.get('/sign-token/:requestKey', (req, reply) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    fastify.post('/save-config/:requestKey', { preHandler: [fastify.authenticate] }, (req, reply) => __awaiter(void 0, void 0, void 0, function* () {
        const requestKey = req.params.requestKey || '??';
        const province = req.body.province || 0;
        ...
        if (userInfo && req.body.requestKey === hashRequestKey && requestKey === hashRequestKey
            ...
            const resultRename = yield renameFile(configFileName, configFileNameBak);
            console.log('====> resultRename', resultRename, moment().locale('th').format('HH:mm:ss.SS'));
            const resultSaveConfig = yield saveConfig(req.raw['ip'], body, userInfo, configFileName, configFileNameBak);
    ...
    fastify.get('/status', (req, reply) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    fastify.get('/autosent-result', { preHandler: [fastify.authenticate] }, (req, reply) => __awaiter(void 0, void 0, void 0, function* () {
        try {
    ...
    function saveConfig(ip, body, userInfo, configFileName, configFileNameBak) {
