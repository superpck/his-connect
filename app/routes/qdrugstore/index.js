...
const router = (fastify, {}, next) => {
    ...
    fastify.post('/procedure-opd', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            const result = await his_1.default.getProcedureOpd(global.dbHIS, visitNo, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
    ...
    fastify.post('/procedure-ipd', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            const result = await his_1.default.getProcedureIpd(global.dbHIS, an, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
            console.log('procudure_opd', error.message);
    ...
    fastify.post('/drug-opd-refer', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            const result = await his_1.default.getDrugOpd(global.dbHIS, visitNo, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
    ...
    fastify.post('/drug-ipd', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            const result = await his_1.default.getDrugIpd(global.dbHIS, an, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
    ...
    fastify.post('/charge-opd', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            const result = await his_1.default.getChargeOpd(global.dbHIS, visitNo, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
    ...
    fastify.post('/charge-ipd', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            const result = await his_1.default.getChargeIpd(global.dbHIS, an, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
    ...
    fastify.post('/accident', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            const result = await his_1.default.getAccident(global.dbHIS, visitNo, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
    ...
    fastify.post('/appointment_refer', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            const result = await his_1.default.getAppointment(global.dbHIS, visitNo, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
    ...
    fastify.post('/refer-history', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            ...
            const result = await his_1.default.getReferHistory(global.dbHIS, typeSearch, textSearch, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
    ...
    fastify.post('/clinical-refer', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            const result = await his_1.default.getClinicalRefer(global.dbHIS, referNo, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
    ...
    fastify.post('/investigation-refer', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            const result = await his_1.default.getInvestigationRefer(global.dbHIS, referNo, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
    ...
    fastify.post('/care-refer', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            const result = await his_1.default.getCareRefer(global.dbHIS, referNo, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
    ...
    fastify.post('/refer-result', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            const result = await his_1.default.getReferResult(global.dbHIS, hospDestination, referNo, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
    ...
    fastify.post('/provider', { preHandler: [fastify.authenticate] }, async (req, reply) => {
        ...
        try {
            const result = await his_1.default.getProvider(global.dbHIS, typeSearch, textSearch, hospcode);
            reply.status(HttpStatus.OK).send({ statusCode: HttpStatus.OK, rows: result });
        }
        catch (error) {
