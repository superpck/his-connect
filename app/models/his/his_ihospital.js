...
class HisIHospitalModel {
    ...
    getReferOut(db, date, hospCode = hisHospcode, visitNo = null) {
        let sql = db('hospdata.refer_out as refer')
            ...
            .select('refer.refer_no as referid', 'refer.refer_type as referout_type', 'refer.refer_hcode as hosp_destination', 'refer_in.refer as hospcode_origin', 'refer_in.refer_no as referid_origin', 'visit.hn', 'pt.no_card as cid', 'refer.vn as seq', 'ipd.an', 'pt.title as prename', 'pt.name as fname', 'pt.surname as lname', 'pt.birth as dob', 'pt.sex', 'refer.treated AS PHYSICALEXAM', 'refer.history_ill as PH', 'refer.current_ill as PI', 'refer.dr_request as REQUEST', 'visit.dx1 as ICD10', 'refer.dx as DIAGLAST', 'refer.dx', 'refer.other as detail', 'vs.nurse_cc as chiefcomp', 'pi_dr as pi', 'pe_dr as pe', 'nurse_ph as ph', db.raw('IF(ipd.an IS NULL,null, concat(ipd.admite," ",ipd.time)) as datetime_admit'), db.raw(`IF(visit.dr > 0, CONCAT("ว",visit.dr),'') as provider`), `visit.dr`, 'refer.dr_request as request', 'refer.causeout')
