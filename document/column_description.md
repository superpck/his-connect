...
หมายเหตุ
```
- ให้ส่งเฉพาะผู้รับบริการที่ต้องการให้ประเมินความพึงพอใจ ไม่ควรส่งไปยังผู้ป่วยที่   
   1) รับไว้รักษา (Admission) ที่ยังไม่จำหน่าย, 
   2) ผู้ป่วยที่ไม่รอตรวจ, 
   3) ผู้ป่วยที่ไม่มาตามนัด, 
   4) ผู้ป่วยที่เรือนจำ, 
   5) ผู้ป่วยที่ทัณฑสถาน
   6) ผู้ป่วยอื่นๆ ที่ไม่สามารถเข้าถึงหมอพร้อมได้
